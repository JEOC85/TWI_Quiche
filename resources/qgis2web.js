...
map.getView().fit([425417.454959, 1741278.055920, 481286.568547, 1778780.118420], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INDICE DE HUMEDAD TOPOGRAFICA DEPARTAMENTO DEL QUICHE</h2>';
        return titleElement;
    })(),
